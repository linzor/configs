...
theme.gtk.menubar_border_color = mix(
    "#000000f5", --theme.gtk.menubar_bg_color,
    "#000000f5", --theme.gtk.menubar_fg_color,
    0.5
)
...
theme.bg_normal     = "#00000000" --theme.gtk.bg_color
theme.fg_normal     = theme.gtk.fg_color

theme.wibar_bg      = "#00000000" --theme.gtk.menubar_bg_color
theme.wibar_fg      = theme.gtk.menubar_fg_color

theme.bg_focus      = "#00000000" --theme.gtk.selected_bg_color
theme.fg_focus      = theme.gtk.selected_fg_color

theme.bg_urgent     = "#00000000" --theme.gtk.error_bg_color
...
theme.tasklist_fg_normal = "#00000000" --theme.wibar_fg
theme.tasklist_bg_normal = "#000000f5"--theme.wibar_bg
theme.tasklist_fg_focus = "#00000000" --theme.tasklist_fg_normal
theme.tasklist_bg_focus = "#00000000" --theme.tasklist_bg_normal
...
theme.titlebar_bg_normal = "#00000000" --theme.gtk.wm_border_unfocused_color
...
theme.titlebar_bg_focus = "#00000000" --theme.gtk.wm_border_focused_color
